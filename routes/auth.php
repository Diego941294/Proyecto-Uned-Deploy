...
/**
 * Rutas de autenticación para usuarios no autenticados (guests)
...
Route::middleware('guest')->group(function () {
    ...
    // Enviar enlace para restablecer contraseña por correo
 ...
 * Incluyen verificación de correo, confirmación de contraseña y logout
 */
Route::middleware('auth')->group(function () {
    // Mostrar página de verificación de correo electrónico
    Route::get('verify-email', EmailVerificationPromptController::class)
        ->name('verification.notice');

    // Verificar correo electrónico con token y hash
